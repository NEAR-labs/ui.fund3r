...
- [ ] http://localhost:3000/grants/t3st.testnet-11 | Should show "Payout proposal successfully created. You will receive soon the first payout" and "Signing of agreement" should be checked and "Upfront payout" pending
