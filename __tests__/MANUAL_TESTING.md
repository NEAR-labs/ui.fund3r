...
- [ ] http://localhost:3000/grants/t3st.testnet-10 | Should show "You successfully signed the agreement, in order to receive the first payment, please submit the proposal to the DAO" and there should be a button "Submit proposal" and Signing of agreement should be checked and On-chain submission should be pending
